...
immune=read.table('./00data/GSE20966/06.immune/3.txt',sep="\t",header=T,row.names=1,check.names=F)
immune1 <- immune[c(1:10),]
immune2 <- immune[c(11:20),]
...
P <- (p1|p2|p3)/(p4|p5|p6)
ggplot2::ggsave(filename = './00data/GSE20966/06.immune/COR.pdf',plot = P, width =8, height =6) 
